...
- can use failure-aware two-draft verification, bounded research retries, and citation checks to keep advisory answers grounded without adding a heavy agent layer
