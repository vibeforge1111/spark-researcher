...
def build_parser() -> argparse.ArgumentParser:
    ...
    _policy_push_group = self_edit_policy_parser.add_mutually_exclusive_group()
    _policy_push_group.add_argument("--push", action="store_true")
    _policy_push_group.add_argument("--no-push", action="store_true")
    ...
    _apply_push_group = self_edit_apply.add_mutually_exclusive_group()
    _apply_push_group.add_argument("--push", action="store_true")
    _apply_push_group.add_argument("--no-push", action="store_true")
