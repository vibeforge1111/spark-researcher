...
def test_trainer_public_results_are_metadata_only_while_private_state_keeps_redacted_diagnostics(
    ...
    assert str(repo_root) not in private_state["stderr_excerpt"]
    assert private_state["stderr_excerpt"] == "fatal: cannot read <path>"
